# ATCRoster marketing site

Standalone static marketing-site files, built from repository-verified product
claims in `../docs/product-truth-matrix.md` and
`../docs/website-product-specification.md`.
