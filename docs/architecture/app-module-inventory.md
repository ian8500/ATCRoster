...
| /admin/operational-currency | `admin_operational_currency` | GET, POST | Authenticated account | Admin/editor action policy | Verified active unit | Global default-deny | admin_operational_currency.html | `atcroster.live_position.currency` + injected dependencies |
...
| /admin/toil/new | `admin_toil_new` | GET, POST | Authenticated account | Admin/editor action policy | Verified active unit | Global default-deny | admin_toil_new.html | `atcroster.administration.toil` + injected dependencies |
...
| /administration/kiosk-accounts | `kiosk_accounts` | GET, POST | Authenticated account | UnitAdmin/domain policy | Verified active unit | Global default-deny | kiosk_accounts.html | `atcroster.accounts.kiosk` + injected dependencies |
...
| /password | `password_change` | GET, POST | Authenticated account | Endpoint/domain permission | Verified active unit | Global default-deny | password.html | `atcroster.accounts.password` + injected dependencies |
...
| /platform/worker-health | `platform_worker_health` | GET | Platform identity + MFA | SuperAdmin/platform policy | Control DB/platform | Not applicable (safe method) | JSON/redirect/response | `atcroster.platform.worker_health` + injected dependencies |
