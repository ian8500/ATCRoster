...
- The legacy `app.py` remains about ten thousand lines. Production operations are
  now extracted, but distributed route/business logic remains a maintainability
  and review risk.
