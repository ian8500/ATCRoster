...
register_account_runtime_blueprints(
    ...
    saas_models=SaaS,
    services=SimpleNamespace(
        deployment_environment=DEPLOYMENT_ENV, current_unit_id=_current_unit_id,
        is_admin_user=is_admin_user, is_editor_user=is_editor_user,
        validate_csrf=_validate_csrf, consume_rate_limit=_consume_rate_limit,
        valid_email=_valid_email, normalized_login=_normalized_login,
        platform_support_emails=_platform_support_emails,
        unit_admin_emails=_unit_admin_emails, send_email=_send_account_email,
        now=utcnow, active_recovery=_active_recovery_from_digest,
        bind_authenticated_unit=bind_authenticated_unit,
        generate_password_hash=generate_password_hash, tenant_get=tenant_get,
        run_signup=_run_invitation_signup, signup_error=SignupWorkflowError,
        normalise_uk_mobile=_normalise_uk_mobile,
        normalise_phone=_normalise_phone_number, qr_data_uri=_totp_qr_data_uri,
