...
from atcroster.roster import (
    ...
    is_month_locked as roster_period_is_locked,
    lock_date_for_month as roster_period_lock_date,
    memoize,
    month_add as roster_period_add,
    ShiftCounterService,
    parse_hhmm as parse_roster_hhmm,
    parse_iso_date as parse_roster_date,
...
_bind_tenant_context, _reset_tenant_context = register_tenant_hooks(
    ...
    TenantHookDependencies(
        ...
        enforce_session=lambda user: _session_lifecycle_reference.get().enforce_request(
            user
        ),
...
_security_headers = register_security_headers(
    ...
    SecurityHeaderDependencies(
        ...
        slow_roster_seconds=float(
            os.environ.get("ATCROSTER_SLOW_ROSTER_SECONDS", "2.0")
        ),
    ),
)
...
(
    ...
    HandoverEquipment,
    HandoverField,
    HandoverOperationalState,
    HandoverRecord,
) = (
    _operational_models.AnnotationAudit,
    _operational_models.AnnotationType,
    _operational_models.Assignment,
    _operational_models.ChangeLog,
    _operational_models.Leave,
    _operational_models.Notification,
    _operational_models.RequestAudit,
    _operational_models.Requirement,
    _operational_models.RosterSetting,
    _operational_models.ShiftRequest,
    _operational_models.ShiftType,
    _operational_models.Sickness,
    _operational_models.SmsAudit,
    _operational_models.SmsSenderRegistration,
    _operational_models.SpecialRequirement,
    _operational_models.Staff,
    _operational_models.StaffWatchHistory,
    _operational_models.TrainingLevel,
    _operational_models.TrainingObjective,
    _operational_models.TrainingScore,
    _operational_models.TrainingSession,
    _operational_models.Unit,
    _operational_models.Watch,
    _operational_models.HandoverEquipment,
    _operational_models.HandoverField,
    _operational_models.HandoverOperationalState,
...
(
    ...
    Scenario,
    OperationalPosition,
    OperationalPositionTimeAllowance,
    LivePositionRecoveryPolicy,
    OperationalPositionGroup,
    PositionCurrencyCategory,
    PositionParticipantRole,
    PositionStatusEvent,
    PositionSession,
    PositionSessionParticipant,
    ControllerKioskCredential,
    ...
    WorkPattern,
    WorkPatternDay,
    WorkPatternDayAllowedShift,
    StaffPatternAssignment,
    StaffRule,
    BankHoliday,
    RosterProposal,
    RosterProposalAssignment,
    RosterRuleVersion,
    RosterPeriod,
    RosterImpactEvent,
    RosterImpactException,
    MfaCredential,
) = (
    SaaS.PlatformIdentity,
    SaaS.PlatformMfaCredential,
    SaaS.UnitMembership,
    SaaS.SecureInvitation,
    SaaS.SignupWorkflow,
    SaaS.RecoveryRequest,
    SaaS.ProvisioningJob,
    SaaS.WorkerHeartbeat,
    SaaS.FeatureFlag,
    SaaS.PlanHistory,
    SaaS.AggregateUsageEvent,
    SaaS.SuperAdminAudit,
    SaaS.CentralSecurityAudit,
    SaaS.QualificationType,
    SaaS.PersonQualification,
    SaaS.PersonQualificationHistory,
    SaaS.RosterPublication,
    SaaS.RosterAcknowledgement,
    SaaS.Scenario,
    SaaS.OperationalPosition,
    SaaS.OperationalPositionTimeAllowance,
    SaaS.LivePositionRecoveryPolicy,
    SaaS.OperationalPositionGroup,
    SaaS.PositionCurrencyCategory,
    SaaS.PositionParticipantRole,
    SaaS.PositionStatusEvent,
    SaaS.PositionSession,
    SaaS.PositionSessionParticipant,
    SaaS.ControllerKioskCredential,
    SaaS.PositionSessionAudit,
    SaaS.PositionEndorsement,
    SaaS.PositionRequirement,
    SaaS.BreakPlan,
    SaaS.AchievedDuty,
    SaaS.FatigueReport,
    ...
    SaaS.WorkPattern,
    SaaS.WorkPatternDay,
    SaaS.WorkPatternDayAllowedShift,
    SaaS.StaffPatternAssignment,
    SaaS.StaffRule,
    SaaS.BankHoliday,
    SaaS.RosterProposal,
    SaaS.RosterProposalAssignment,
    SaaS.RosterRuleVersion,
    SaaS.RosterPeriod,
    SaaS.RosterImpactEvent,
    SaaS.RosterImpactException,
    SaaS.MfaCredential,
)
...
(
    ...
    _briefing.BriefingAssuranceRun,
    _briefing.BriefingAudit,
    _briefing.BriefingDelivery,
    _briefing.BriefingItem,
    _briefing.BriefingMessageType,
    _briefing.blueprint,
    _briefing.enabled,
    _briefing.local_now,
)
...
APPEND_ONLY_AUDIT_MODELS = append_only_audit_models(
    SaaS, _operational_models, _briefing
)
...
if DEPLOYMENT_ENV != "production" and os.environ.get(
    "ATCROSTER_SKIP_BOOTSTRAP", ""
...
def load_user(user_id):
    return load_identity(
        ...
        deployment_environment=DEPLOYMENT_ENV,
        bind_authenticated_unit=bind_authenticated_unit,
        remember_tenant_token=lambda token: setattr(g, "tenant_context_token", token),
    )
...
roster_settings_catalogue.set_secondary_cache_clear(_shift_groups_snapshot.cache_clear)
...
roster_impact_runtime = RosterImpactRuntime(
    create_roster_impact_runtime_dependencies(
        db=db,
        operational_models=_operational_models,
        saas_models=SaaS,
...
fatigue_runtime = FatigueRuntime(
    create_fatigue_runtime_dependencies(
        operational_models=_operational_models,
        get_shift=get_shift,
...
lock_date_for_month = partial(
    roster_period_lock_date, roster_lock_date=roster_lock_date
)
is_month_locked = partial(
    roster_period_is_locked, roster_month_is_locked=roster_month_is_locked
)

roster_editing_runtime = RosterEditingRuntime(
    create_roster_editing_dependencies(
        db=db,
        operational_models=_operational_models,
        current_unit_id=_current_unit_id,
...
allocation_runtime = AllocationRuntime(
    create_allocation_runtime_dependencies(
        db=db,
        operational_models=_operational_models,
        current_unit_id=_current_unit_id,
...
overtime_support = OvertimeSupport(
    create_overtime_support_dependencies(
        operational_models=_operational_models,
        parse_annotation=parse_annotation,
...
request_workflow_service = RequestWorkflowService(
    create_request_workflow_dependencies(
        db=db,
        operational_models=_operational_models,
        current_unit_id=_current_unit_id,
...
qualification_runtime = QualificationRuntime(
    create_qualification_runtime_dependencies(
        db=db,
        operational_models=_operational_models,
        saas_models=SaaS,
...
_central_security_event = partial(
    record_central_security_event, db, CentralSecurityAudit
)
...
for cli_command in create_cli_commands(
    CliDependencies(
        db=db,
        PlatformIdentity=PlatformIdentity,
...
roster_period_service = RosterPeriodService(
    create_roster_period_dependencies(
        db=db,
        saas_models=SaaS,
        utcnow=utcnow,
...
publication_service = create_publication_service(
    create_publication_dependencies(
        db=db,
        operational_models=_operational_models,
        saas_models=SaaS,
...
_briefing.configure_dependencies(
...
register_platform_blueprints(
    ...
    services=SimpleNamespace(
        ...
        redis_health_check=(
            _rate_limiter.verify if hasattr(_rate_limiter, "verify") else lambda: None
        ),
        invalidate_roster_cache=roster_month_cache.invalidate_unit,
        deployment_environment=DEPLOYMENT_ENV,
    ),
)
