...
__all__ = ("LOCKED_SOURCES", "assignment_for_day", "cell_is_protected", "duration_minutes", "expand", "invalidate_month_for_day", "is_month_locked", "is_non_working", "is_sunday", "is_working_with_prefix", "lock_date_for_month", "lock_roster_month", "memoize", "month_add", "month_has_data", "normalize_code", "parse_annotation", "parse_hhmm", "parse_iso_date", "parse_year_month", "set_assignment_code", "shift_groups_snapshot", "validate")
